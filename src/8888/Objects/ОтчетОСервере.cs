...
namespace IIS.8888
{
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.8888.РежимСервера fРежим;
        
        private IIS.8888.Расположение fРасположение;
        ...
        public virtual IIS.8888.РежимСервера Режим
        {
            get
            {
                ...
                IIS.8888.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.8888.Расположение Расположение
        {
            get
            {
                ...
                IIS.8888.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.8888.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.8888.ОтчетОСервере));
                }
            }
        }
    }
